...
public class ProdutoPainel extends JPanel implements ActionListener {
	ImageIcon linha = new ImageIcon(getClass().getResource("linha.png"));
	JLabel Linha = new JLabel(linha);
	public JButton adicionar, pesquisar, remover, voltar;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(voltar)) {
			...
			Janela.getInstance().PesquisarProdutoPainel.setVisible(false);
		...
		if(e.getSource().equals(adicionar)) {
			Janela.getInstance().PadraoPainel.setVisible(false);
			Janela.getInstance().AddProdutoPainel.setVisible(true);
			Janela.getInstance().PesquisarProdutoPainel.setVisible(false);
			Janela.getInstance().RemoverProdutoPainel.setVisible(false);
		}
		...
		if(e.getSource().equals(remover)) {
			...
			Janela.getInstance().AddProdutoPainel.setVisible(false);
			Janela.getInstance().PesquisarProdutoPainel.setVisible(false);
			Janela.getInstance().RemoverProdutoPainel.setVisible(true);
		}
		
		if(e.getSource().equals(pesquisar)) {
			Janela.getInstance().PadraoPainel.setVisible(false);
			Janela.getInstance().AddProdutoPainel.setVisible(false);
			Janela.getInstance().PesquisarProdutoPainel.setVisible(true);
			Janela.getInstance().RemoverProdutoPainel.setVisible(false);
		}
	}
}
